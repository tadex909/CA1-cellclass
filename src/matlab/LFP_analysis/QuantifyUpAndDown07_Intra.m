function  QuantifyUpAndDown05 
 ...
 addpath(genpath('/Users/jeromeepsztein/Documents/jerome/Articles/past/1-Ouedraogo_et_al/Analysis_programs_Ouedraogo_paper'));
...
[SpecIntra,t,f]=mtspecgramc(dataShort,[5 0.2],params);% do the spectrogram on 5sec data length with 0.2 sec taper
...
t = [1 1501];
figure
imagesc(t,f,SpecIntra',[0 2000])% or [0 3E5] for extra
hold on
