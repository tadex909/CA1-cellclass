...
prm.rmap.frmax = 1.5; %1.5 %1  %%%%% 
prm.rmap.frmean = 0.5; %0.5 %0.3
prm.rmap.pctspklap = 0.50;  %%% ancien 0.50

prm.pf.mtd = 'poisson'; %poisson %random

prm.pf.nb_rep = 1000; %500 %1000

prm.pf.min_len = 3;
prm.pf.max_len = 25; %Max length %OLDrom = 45

prm.pf.max_btw_pf = 5; %max dist between 2 pour merged
prm.pf.max_ext_pf = 0; %oldrom=5 %etendre pf  si pval=0.30
...
prm.pf.pctstab = 0.5; %%%% 40%des essais %OLDROM=0.4
